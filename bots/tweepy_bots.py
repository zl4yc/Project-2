...
def reply_to_tweets():
    ...
    for mention in reversed(mentions):
        ...
        if ('help!' or 'info!') in mention.text.lower():
            ...
            try:
                api.update_status(status = '@' + mention.user.screen_name + 
                                  ' Please refer to https://github.com/zl4yc/Project-2/blob/main/README.md for detailed instruction', in_reply_to_status_id = mention.id)
        ...
        # the last two cases: a valid stock price ticker or unsupported message
            ...
            try:
                ...
                try:
                    api.update_status(status = '@' + mention.user.screen_name + 
                                      ' Sorry I do not understand. Please refer to https://github.com/zl4yc/Project-2/blob/main/README.md for more information', in_reply_to_status_id = mention.id)
